 ...
 * content column is centered so it also reads well on desktop. NavLink's
 * default (non-"end") matching keeps "Lists" highlighted while on a nested
 * /lists/:id detail page too.
 */
